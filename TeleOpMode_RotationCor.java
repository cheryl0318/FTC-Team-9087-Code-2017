...
@TeleOp(name="Teleop Rotation OpMode", group="Iterative Opmode")

public class TeleOpMode_RotationCor extends OpMode
...
//        if (robot.colorSensor.red() > 15 && robot.colorSensor.red() > robot.colorSensor.blue())
        ...
        robot.DriveMecanum(gamepad1.left_stick_x*max,-gamepad1.left_stick_y*max, (gamepad1.right_stick_x*max*-1) + 0.045);
